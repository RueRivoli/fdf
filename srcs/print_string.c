...
int    print_title(t_env *env)
{
    ...
    */
    ...
    mlx_string_put(env->mlx, env->win, 30, 600, 0xFB9800, " \"Success consists of going");
     mlx_string_put(env->mlx, env->win, 30, 650, 0xFB9800, " from failure to failure ");
    mlx_string_put(env->mlx, env->win, 30, 700, 0xFB9800, " without loss of enthusiasm\"");
    ...
    */
    ...
    mlx_string_put(env->mlx, env->win, 1650, 500, 0xD3D3DA, "Zoom : scroll arriere");
    mlx_string_put(env->mlx, env->win, 1650, 550, 0xD3D3DA, "Dezoom : scroll avant");
